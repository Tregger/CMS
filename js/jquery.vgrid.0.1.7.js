...
function getProps(toObj, tcSplit)
{
  ...
  return lcRet;
	...
	function makePos(self, initpos) //mod (added initpos argument)
	{
		...
		var _selRefGrid = self.data("_vgopt").selRefGrid || "#wrapper div.content_block";
		
		var _selFitWidth = self.data("_vgopt").selFitWidth || "#wrapper";
		...
		var _adjL = (initpos) ? Number(0.5) : Number(1);
		
		var _adjT = (initpos) ? Number(0.5) : Number(1);
		/* ----- mod end ----- */
