					...
					<div class="column2">
						...
						<div class="clearfix2">
							<span></span>
                                            ...
                                            <!- -- -->
                                            <table id="example" style=" width: 747px;">
                                                <thead>
                                                    <th>Subject</th>
                                                    <th>From</th>
                                                    <th>Message</th>
                                                ...
                                                <tbody>
                                           {foreach from=$messages_user item=item }
                                               <tr>
                                                   <td><a href="/index.php?page=mynorshin&action=inbox&id={$item.id}">{$item.subject}</a></td>
                                                   <td>{display_username id=$item.id_who}</td>
                                                   <td>{$item.text}</td>
                                                   <td>{$item.date}</td>
                                               </tr>
                                           {/foreach}
