...
$tinybrowser['path']['image'] = '/fotogalery/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/fotogalery/'; // Media files location
$tinybrowser['path']['file']  = '/fotogalery/'; // Other files location
