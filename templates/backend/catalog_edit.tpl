...
<form method="post">
    <input type="hidden" name="record[type]" value="{if $record.folder eq "1"}cat{else}rec{/if}" />
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                {include file='catalog_list_add.tpl' selected="{$record.id_p}"} 
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <textarea name="record[sdesc]" > {$record.sdescr} </textarea>
            </td>
        </tr>
        {if $tip ne "cat"}
        <tr>
            ...
            <td>
                <textarea name="record[fdesc]">{$record.fdescr}</textarea>
            </td>
        </tr>
        {/if}
        <tr>
            ...
            <td>
                <input type="text" name="record[url]" value="{$record.url}" />
            </td>
        </tr>
        {if $tip ne "cat"}
        <tr>
            ...
            <td>
                <input type="text" name="record[price]" value="{$record.price}" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <select name="record[prod]" >
                    {display_producers_select var={$record.prod}}
                </select>
            </td>
        </tr>
        ...
        <tr>
         ...
         <tr>
           ...
           <TR>
            <td colspan=2><input type="checkbox" name="record[actia]" value="1" {if $record.promo==1}checked{/if}>
        </tr>
          <tr>
            <td colspan=2>Пометить, что товар является новинкой </td>
           </tr>
           <TR>
            <td colspan=2><input type="checkbox" name="record[hit]" value="1" {if $record.hit==1}checked{/if}>
        </tr>
        {/if}
        <tr>
