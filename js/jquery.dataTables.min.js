...
this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
                ...
                sLengthMenu: "Показать _MENU_ записей на странице", sZeroRecords: "No results", sEmptyTable: "No data", sInfo: "Показано c _START_ по _END_ из _TOTAL_ записей", sInfoEmpty: "Показано 0 из 0 записей", sInfoFiltered: "(Выбрано _MAX_ записей)", sInfoPostFix: "", sSearch: "Поиск по результатам:", sUrl: "", oPaginate: { sFirst: "Начало", sPrevious: "Назад", sNext: "Вперед", sLast: "Конец" }, fnInfoCallback: null
